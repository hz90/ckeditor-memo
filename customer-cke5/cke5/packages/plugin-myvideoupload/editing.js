...
import { COMMAND_NAME__FILE_VIDEO, SCHEMA_NAME__FILE_VIDEO } from "./constant";
import { createImageViewElement, createImageModel } from './utils';
export default class MyVideoEditing extends Plugin {
  static get requires() {
		return [ FileRepository, Notification ];
	}
  static get pluginName() {
    return "MyVideoEditing";
  }
  init() {
    ...
    // 注册一个 BoldCommand 命令
    editor.commands.add(COMMAND_NAME__FILE_VIDEO, new FileCommand(editor));
