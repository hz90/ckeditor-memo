...
public class FileManagerImpl implements FileManager {
    ...
    @Override
    public String upload(CommonsMultipartFile multipartFile,String kbn) {
//        String storageRoot = Consts.FILE_STORAGE_ROOT+ File.separator+"images";
        String storageRoot = Consts.FILE_STORAGE_ROOT+ File.separator+kbn;
        String path = "";
        ...
        try {
            ...
            path = "http://localhost:8080/"+fileName;
           // if("video".equals(kbn)){
          //      path = fileName;
         //   }
//            path = storageRoot+File.separator+fileName;
        }catch (IOException e){
            e.printStackTrace();
        }
        return path;
